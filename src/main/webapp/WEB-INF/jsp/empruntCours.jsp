                                ...
                                <c:forEach items="${documents}" var="emp">
                                    <tr>
                                        ...
                                        <td class="align-middle text-center text-sm">
                                            ...
                                            <button type="button" class="btn btn-warning  text-xs" data-toggle="modal" data-target="#terminateEmp_${emp.id}">Terminer </button>
                                    ...
                                    <div class="modal fade" id="terminateEmp_${doc.id}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
