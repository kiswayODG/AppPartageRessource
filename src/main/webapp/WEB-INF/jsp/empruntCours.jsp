...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto  max-height-vh-100 h-100" id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link active " href="/emprunt.enCours">
                    <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
    ...
    <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur" navbar-scroll="true">
        <div class="container-fluid py-1 px-3">
            <nav aria-label="breadcrumb">
                ...
                <h6 class="font-weight-bolder mb-0">Mon emprunt en cours</h6>
            </nav>
                    ...
                    <div class="card-body px-0 pt-0 pb-2">
                        <div class="table-responsive  p-0">
                            ...
                            <table class="table align-items-center mb-0" id="dataTable" >
                                ...
                                <tbody id="table-body">
                                <c:forEach items="${documents}" var="emp">
                                    <tr>
                                        <td>
                                        ...
                                        <td>
                                            <div class="align-middle text-center text-sm">
                                                <h6 class="mb-0 ">${emp.doc.type.libelle}</h6>
                                            </div>
                                        </td>
                                        <td class="align-middle text-center text-sm">
                                            <span class="badge badge-sm bg-gradient-${emp.doc.etat == "neuf" ? "success" : "secondary"}">${emp.doc.etat}</span>
                                        </td>

                                        <td class="align-middle text-center text-sm">

                                            <button type="button" class="btn btn-warning  text-xs" data-toggle="modal" data-target="#terminateEmp_${emp.doc.id}">Terminer </button>
                                    ...
                                    <div class="modal fade" id="terminateEmp_${emp.doc.id}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                            ...
                                            <div class="modal-content">
                                                <form:form method="POST" modelAttribute="doc">
                                                    ...
                                                    <div class="modal-body">
                                                        <input type="text" name="emp_id" value="${emp.id}" hidden="true"  class="form-control"/>
                            ...
                            <p class="text-center" style="margin-top: 20px"> ${documents.size()==0 ? "Aucun emprunt en cours !" : ""} </p>
